...
import 'package:caregiver_app/helperFunction/sharedpref_helper.dart';
import 'package:caregiver_app/screens/register/register.dart';
...
class _SignInState extends State<SignIn> {
  ...
  void _signInWithEmailAndPassword() async {
    try {
      ...
      await SharedPreferenceHelper().saveAccountType(basicInfo['type']== 'caregiver'? true :false);
